...
using Zata.Extension.System.Collections.Generic;

namespace Zata.Values
{
    public static class ObjectHelper
    {
        private static readonly ConcurrentDictionary<string, PropertyInfo?> CachedObjectProperties = new ();

        public static void TrySetProperty<TObject, TValue>(TObject obj, Expression<Func<TObject, TValue>> propertySelector, Func<TValue> valueFactory, params Type[] ignoreAttributeTypes) => TrySetProperty(obj, propertySelector, x => valueFactory(), ignoreAttributeTypes);
